...
<details>
   ...
   The files: example.pdf.aux, example.pdf.log and example.pdf.pdf were generated.
</details>

<details>
    <summary>How do you change the name of the pdf-file?</summary>
by using the command "mv". 
For example: mv example.pdf.pdf newname.pdf.pdf .
Now the name is changed from "example.pdf.pdf to newname.pdf.pdf     
</details>
...
I did Task 1-4. It took me 100 minutes and 43 seconds because I had problems with task 2. 
